...
parser.add_argument("-i", "--input-directory", metavar = '', help="The folder you want to convert", type = str)
parser.add_argument("-o", "--output-directory", metavar = '', help="The name of HTML folder", type = str)
parser.add_argument("-t", "--template-directory", metavar = '', help="The name of your template file", type = str)
...
def convert():
    for md_file in listdir(arg.input_directory):
        if not md_file.endswith('.md'):
            print('Mauvaise extensions de fichier')
        else:
